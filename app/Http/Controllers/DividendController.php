...
class DividendController extends Controller
{
    ...
    public function create()
    {
        ...
        $cutoffCadang = ($tahunCadang) . '-06-30';
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'tarikh_cutoff'   => ['required', 'date'],
            'untung_bersih'   => ['required', 'numeric', 'min:0'],
            'peratus_dividen' => ['required', 'numeric', 'min:0', 'max:100'],
        ...
        $run = DividendRun::create([
            ...
            'peratus_dividen' => $data['peratus_dividen'],
    ...
    public function update(Request $request, DividendRun $dividen)
    {
        ...
        // Jika cutoff berubah, kira semula saham layak (kecuali yang di-override)
        if ($cutoffBerubah) {
