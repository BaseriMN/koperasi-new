...
class TransactionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('transaksi.index', compact('transactions', 'members'));
    }
    ...
    public function shareTransferForm()
    {
        ...
        return view('transaksi.pindah_saham', compact('members'));
    }
    ...
    public function ownershipTransferForm(Member $member)
    {
        ...
        return view('transaksi.pindah_milik', compact('member', 'users'));
    }
    ...
    private function recordTransaction(
        ...
        $bakiBaru   = $arah === 'masuk' ? $bakiSemasa + $amaun : $bakiSemasa - $amaun;
