    ...
    <div class="sheet">
        ...
        <div class="body">
            ...
            <div class="info">
                ...
                <div><div class="k">Tarikh Cut-off</div><div class="v">{{ $dividen->tarikh_cutoff->translatedFormat('d M Y') }}</div></div>
            </div>
            ...
            <table>
                ...
                <tr>
                    <td>Peratus Bahagian</td>
                    <td class="amt">{{ rtrim(rtrim(number_format($bahagian->peratus, 4), '0'), '.') }}%</td>
                </tr>
                <tr>
                    <td>Jumlah Dividen Diagihkan (Koperasi)</td>
                    <td class="amt">RM {{ number_format($dividen->jumlah_dividen, 2) }}</td>
                </tr>
                <tr class="total">
                    <td>Dividen Anda</td>
            ...
            <p style="margin-top:20px;font-size:13px;color:var(--muted);line-height:1.6;">
                Dividen ini telah dikreditkan ke akaun saham anda
                @if ($dividen->isMuktamad()) pada {{ optional($dividen->tarikh_muktamad)->translatedFormat('d M Y') }}.
                @else (status: belum dimuktamadkan). @endif
            </p>
        </div>
