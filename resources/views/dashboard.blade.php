...
<div class="grid grid-3" style="margin-bottom:26px;">
    <div class="stat"><div class="k">Jumlah Ahli Aktif</div><div class="v" id="s1" data-target="{{ $stats['ahli'] }}">0</div><div class="meta">▲ aktif dalam sistem</div></div>
    ...
    <div class="stat"><div class="k">Jumlah Pinjaman Terkumpul</div><div class="v">RM <span id="s4" data-target="{{ (int) $stats['pinjaman_total'] }}">0</span></div><div class="meta" style="color:var(--gold);">Telah Diluluskan</div></div>
</div>
