...
<head>
    ...
    <title>@yield('title', 'Dashboard') — Koperasi CMS</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .side-foot { margin-top: auto; padding-top: 18px; border-top: 1px solid rgba(255,255,255,.07); }
    ...
    <aside class="sidebar" :class="{ 'show': sidebarOpen }" id="sidebar">
        ...
        <div class="side-foot">
            <div class="side-user">
                ...
                <div class="avatar">{{ strtoupper(substr($cu->name ?? 'U', 0, 1)) }}</div>
                <div>
    ...
    <div class="main">
        <header class="topbar">
            ...
            <div class="top-actions">
                ...
                <div class="avatar" title="{{ $cu->name ?? '' }}">{{ strtoupper(substr($cu->name ?? 'U', 0, 1)) }}</div>
            </div>
        </header>
