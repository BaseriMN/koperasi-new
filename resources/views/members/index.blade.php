...
<div class="panel">
    ...
    <table>
        <thead>
            <tr><th>No. Ahli</th><th>Nama / Pemilik</th><th>Telefon</th><th>Saham</th><th>Simpanan</th><th>Status</th><th style="text-align:right;">Tindakan</th></tr>
        </thead>
        <tbody>
            @forelse ($members as $m)
                <tr>
                    ...
                    <td>
                        <div class="cell-main">
                            <div class="av">{{ strtoupper(substr($m->nama, 0, 1)) }}</div>
                            <div>
